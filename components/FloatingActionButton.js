...
const FloatingActionButton = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.mediaHeadingContainer}>
      <Text style={styles.mediaHeading}>Media</Text>
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    flexDirection: 'row',
    justifyContent: 'space-between', // Align items at the edges
    alignItems: 'center',
    marginBottom: 20,
  },
  header: {
    fontSize: 24,
    fontWeight: 'bold',
    color: '#6200ee', // Change this color to your preferred one
    flex: 1,
    textAlign: 'center', // Center the text horizontally
  },
  dots: {
    fontSize: 24,
    color: '#6200ee', // Or any other color you prefer
  },
  fab: {
    position: 'absolute',
    bottom: 30,
  ...
  mediaHeading: {
    fontSize: 20,
    fontWeight: 'bold',
    color: '#000',  // Choose a color that fits your design
  },
  dots: {
    fontSize: 24,
    color: '#6200ee',  // Or any other color you prefer
